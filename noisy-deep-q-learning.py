...
class NoisyLayer(nn.Module):
    ...
    def parameter_initialization(self):
        self.mu_bias.data.fill_(self.sigma * self.bound)
        self.sigma_bias.data.uniform_(-self.bound, self.bound)
        self.mu_weight.data.fill_(self.sigma * self.bound)
        self.sigma_weight.data.uniform_(-self.bound, self.bound)
    ...
    def get_noise_tensor(self, features):
